...
class MainWindowUI(QMainWindow):
    ...
    def initUI(self):
        ...
        self.lbl_l1_clip = QLabel("L1 Midtone Clip:")
        self.spin_l1_clip = QSpinBox()
        self.spin_l1_clip.setRange(0, 255)
        self.spin_l1_clip.setValue(170)
        self.spin_l1_clip.setToolTip("Pixels around this value become flat Light Gray.")
        form_layout.addRow(self.lbl_l1_clip, self.spin_l1_clip)

        self.lbl_l2_clip = QLabel("L2 Midtone Clip:")
        self.spin_l2_clip = QSpinBox()
        self.spin_l2_clip.setRange(0, 255)
        self.spin_l2_clip.setValue(85)
        self.spin_l2_clip.setToolTip("Pixels around this value become flat Dark Gray.")
        form_layout.addRow(self.lbl_l2_clip, self.spin_l2_clip)
